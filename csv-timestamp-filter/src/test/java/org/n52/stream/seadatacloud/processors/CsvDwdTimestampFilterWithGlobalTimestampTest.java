...
@ActiveProfiles("dwd-global")
public class CsvDwdTimestampFilterWithGlobalTimestampTest extends AbstractDwdCsvTimestampFilterTest{

    private int ignoredData = 11;
